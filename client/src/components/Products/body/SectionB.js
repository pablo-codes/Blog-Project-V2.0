...
import css from '../../add/AddUser.module.css'
...
const SectionB = (props) => {
  ...
  return (
    ...
    <section className="wrapper bg-light" onDoubleClick={Click}   >
          ...
          <div className="col-lg-8">
            <div className="blog single">
              <div className="card">
                ...
                <figure className="card-img-top">{state ? <img id='images' src={require(`../../../images/dynamic/${pics}`)} alt="" /> : <label htmlFor='files' style={{ position: "relative", left: '45%' }}><div class="icon-div">
                  <div className="icon">+ pic</div>
                </div><input type='file' id='files' name='files' style={{ display: 'none' }} /></label>}</figure>
                <div className="card-body">
                  <div className="classic-view">
                    <article className="post">
                      <div className="post-content mb-5">{state ? <h2 className="h1 mb-4">{props.title}</h2> : <div className={css.col75}>
                        <input type="text" id="fname" style={{ width: '50%', float: 'none' }} name="title" value={props.title} placeholder="please ensure your title is unique " />
                      </div>}

                        {state ? <div><p style={{ fontSize: '200%', color: 'black' }}>{props.description}</p> <p>Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vestibulum id ligula porta felis euismod semper.</p>
                          ...
                          <textarea id="subject" name="description" value={props.description} placeholder="Write something.." style={{ height: "200px", float: 'none' }}></textarea>
                        }
                        <div className="row g-6 mt-3 mb-10">
                          <div className="col-md-6">
                            <figure className="hover-scale rounded cursor-dark">{state ? <a href={require("../../../images/static/b8.jpg")} > <img src={require("../../../images/static/b8.jpg")} alt="" /></a> : <label htmlFor='files' style={{ position: "relative" }}><div class="icon-div">
                              <div className="icon">+ pic</div>
                            </div><input type='file' id='files' name='files' style={{ display: 'none' }} /></label>}</figure>
                          </div>
                          {/* <!--/column --> */}
                          <div className="col-md-6">
                            <figure className="hover-scale rounded cursor-dark">{state ? <a href={require("../../../images/static/b9.jpg")} > <img src={require("../../../images/static/b9.jpg")} alt="" /></a> : <label htmlFor='files' style={{ position: "relative" }}><div class="icon-div">
                              <div className="icon">+ pic</div>
                            </div><input type='file' id='files' name='files' style={{ display: 'none' }} /></label>}</figure>
                          </div>
                          {/* <!--/column --> */}
                          <div className="col-md-6">
                            <figure className="hover-scale rounded cursor-dark">{state ? <a href={require("../../../images/static/b10.jpg")} > <img src={require("../../../images/static/b10.jpg")} alt="" /></a> : <label htmlFor='files' style={{ position: "relative", width: '500px' }}><div class="icon-div">
                              <div className="icon">+ pic</div>
                            </div><input type='file' id='files' name='files' style={{ display: 'none' }} /></label>}</figure>
                          </div>
                          {/* <!--/column --> */}
                          <div className="col-md-6">
                            <figure className="hover-scale rounded cursor-dark">{state ? <a href={require("../../../images/static/b11.jpg")} > <img src={require("../../../images/static/b11.jpg")} alt="" /></a> : <label htmlFor='files' style={{ position: "relative" }}><div class="icon-div">
                              <div className="icon">+ pic</div>
                            </div><input type='file' id='files' name='files' style={{ display: 'none' }} /></label>}</figure>
                          </div>
                          {/* <!--/column --> */}
                        ...
                        {/* <!-- /.row --> */}{state ?
                          <div> <p>{props.features}</p> <p>Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Aenean lacinia bibendum nulla sed consectetur. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vestibulum id ligula porta felis euismod semper.</p>
                            <p>Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Sed posuere consectetur est at lobortis. Donec id elit non mi porta gravida at eget metus. Nulla vitae elit libero, a pharetra augue. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p></div> :
                          <textarea id="subject" name="features" value={props.features} placeholder="Write something.." style={{ height: "200px", float: 'none' }}></textarea>}
